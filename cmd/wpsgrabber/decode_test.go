...
func TestParseExecuteResponse(t *testing.T) {
	...
	exampleSucceeded := filepath.Join(currentWorkingDir, "resources", "example_succeeded.xml")
	exampleFailed := filepath.Join(currentWorkingDir, "resources", "example_failed.xml")
